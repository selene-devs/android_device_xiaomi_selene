...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.selene.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.selene.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.selene
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.selene.rc \
    android.hardware.wifi@1.0-service.selene.xml
